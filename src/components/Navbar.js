        ...
        <div className='mx-2'>
            <div className='flex justify-between sm:py-4 sm:px-20 sticky h-[10%] shadow-md'>
                ...
                <div className='gap-4 flex items-center'>
                    <button className='cursor-pointer sm:px-3 sm:py-2 hover:bg-[#262626] transition duration-200 rounded-3xl text-sm m-1 text-white border hover:border-[#0A0A0A] p-[1px]'>
                        <span className='flex items-center gap-1'><IoDownloadOutline className='text-lg'/>Download</span>
                    </button>
                    <button className='cursor-pointer sm:px-3 sm:py-2 border hover:border-white shadow-sm border-[#0E9272] hover:bg-[#0E9272] transition duration-200 text-[#3CB371] hover:text-white rounded-2xl text-sm m-1'>
